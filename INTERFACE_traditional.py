...
from SUPPORT_ultrasound_interface import UltrasoundInterface
...
class Traditional(QtGui.QMainWindow):
    def __init__(self, screen_width_input, screen_height_input):
        ...
        # <editor-fold desc="ultrasound interface variables">
        self.ultrasound_interface = None
        # </editor-fold>

        # ---------------------------#
        #     METHOD CALLS           #
        # ---------------------------#
        self.initialize_ultrasound_interface()
        self.load_default_central_image()
        self.setup_gui()
    ...
    # <editor-fold desc="ultrasound interface functions">
    def initialize_ultrasound_interface(self):
        self.ultrasound_interface = UltrasoundInterface(0)
    # </editor-fold>
    ...
    def load_default_central_image(self):
    ...
    def callback_image_update(self):
        ...
        self.image, self.image_width, self.image_height, self.image_diagonal = self.ultrasound_interface.load_image()
